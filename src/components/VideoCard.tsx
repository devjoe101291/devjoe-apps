...
export const VideoCard = ({ title, description, videoUrl, thumbnailUrl }: VideoCardProps) => {
  ...
  return (
    <div className="group relative bg-gradient-to-br from-card to-card/50 border border-border/50 hover:border-primary/50 transition-all duration-500 hover:shadow-[0_0_30px_hsl(193_95%_55%_/_0.2)] rounded-lg overflow-hidden hover:-translate-y-2 hover:scale-[1.02]">
